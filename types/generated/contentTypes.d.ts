...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    rol: Attribute.Enumeration<
      ['cliente', 'camarero', 'cocinero', 'administrador']
    >;
...
export interface ApiDisponibilidadDisponibilidad extends Schema.CollectionType {
  ...
  attributes: {
    ...
    aforo_maximo: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiIngredienteIngrediente extends Schema.CollectionType {
  ...
  attributes: {
    ...
    stock_minimo: Attribute.Decimal;
    receta_ingredientes: Attribute.Relation<
      'api::ingrediente.ingrediente',
      'oneToMany',
      'api::receta-ingrediente.receta-ingrediente'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiPedidoPedido extends Schema.CollectionType {
  ...
  attributes: {
    ...
    estado: Attribute.Enumeration<
      ['pendiente', 'en_proceso', 'completo', 'cancelado']
    >;
    pedido_productos: Attribute.Relation<
      'api::pedido.pedido',
      'oneToMany',
      'api::pedido-producto.pedido-producto'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiPedidoProductoPedidoProducto extends Schema.CollectionType {
...
export interface ApiRecetaIngredienteRecetaIngrediente
  extends Schema.CollectionType {
  ...
  attributes: {
    receta: Attribute.Relation<
      ...
      'api::receta.receta'
    >;
    ingrediente: Attribute.Relation<
      'api::receta-ingrediente.receta-ingrediente',
      'manyToOne',
      'api::ingrediente.ingrediente'
    >;
    cantidad_necesaria: Attribute.Decimal;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiReservaReserva extends Schema.CollectionType {
  ...
  attributes: {
    ...
    hora: Attribute.Time & Attribute.Required;
    comensales: Attribute.Integer & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::pedido-producto.pedido-producto': ApiPedidoProductoPedidoProducto;
      'api::producto.producto': ApiProductoProducto;
      'api::receta.receta': ApiRecetaReceta;
      'api::receta-ingrediente.receta-ingrediente': ApiRecetaIngredienteRecetaIngrediente;
